...
public class Constants {
    ...
    public static final String PLACE_SHARE_TEXT = "Hey ! I came across this place called %s. It has a wifi rating of %s. " +
            "If you want other information about the place, download this app from play store : " + "https://play.google.com/store/apps/details?id=com.valmiki.hotspots";
