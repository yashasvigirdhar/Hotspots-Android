package app.nomad.projects.yashasvi.hotspots.adapters;
...
import app.nomad.projects.yashasvi.hotspots.activities.PlaceViewActivity;
...
public class PlacesRecyclerViewAdapter extends RecyclerView.Adapter<PlacesRecyclerViewAdapter.DataObjectHolder> implements View.OnClickListener {
    ...
    public void onBindViewHolder(DataObjectHolder holder, final int position) {
        ...
        if (area.contains("bangalore") || area.contains("Bangalore"))
